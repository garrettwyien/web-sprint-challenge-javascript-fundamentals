...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Inner functions can access the variables of their parent functions through closures. 
...
class CubeMaker extends CuboidMakerTwo{
  ...
  surfaceArea(){
    let sa = 6 * Math.pow(this.length, 2);
    return sa;
  }
}
...
console.log(cuboidThree.volume()); // 125
console.log(cuboidThree.surfaceArea()); // 150
